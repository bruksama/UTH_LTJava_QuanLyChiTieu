...
import main.java.vn.edu.ut.expensemanager.service.ProfileService;
...
public class ProfileController {
    ...
    public void initialize() {
        ...
        profileService = new ProfileService(new ProfileDAO(),new CategoryDAO(),new TransactionDAO(),new ReportDAO());
